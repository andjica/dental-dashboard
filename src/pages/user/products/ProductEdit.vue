...
const handleEdit = () => {
  if (!hasChanges()) {
    ...
    alertMessage.value = "The data has not been changed.";
  ...
  post(`product/${productId}`, formData)
    .then((data) => {
      ...
      alertMessage.value = "Product is updated successfully!";
