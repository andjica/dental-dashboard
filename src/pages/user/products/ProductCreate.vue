    ...
    <form @submit.prevent="handleSubmit" class="space-y-6" enctype="multipart/form-data">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div>
          ...
          <div class="relative">
            ...
            <svg class="pointer-events-none absolute right-3 top-1/2 h-5 w-5 text-gray-400 transform -translate-y-1/2"
      ...
      <div class="w-full md:w-1/3 md:pr-2 pr-0">
        ...
        <div class="relative">
          ...
          <input id="priceInput" :value="form.price" @input="(e) => cleanNumberInput(e, 'price')"
            @keypress="allowOnlyNumbersAndDot" @blur="formatDisplayPrice" type="text" inputmode="numeric"
            placeholder="0.00"
      ...
      <div>
        ...
        <div class="flex flex-wrap gap-4 mt-4">
          <div v-for="(img, index) in imagePreviews" :key="index"
            ...
            <img :src="img" alt="Selected Image" class="object-cover w-full h-full" />
            <!-- Dugme za uklanjanje -->
